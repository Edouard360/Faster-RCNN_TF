...
def generate_symbols_and_xml(n_images=1, n_samples_per_image=10, max_overlap=0.15, filepath='', image_folder='',
    ...
    with open(filepath +img_list_file, "a") as myfile:
...
def parse_args():
    ...
    parser.add_argument('--filepath', help='you can indicate a common filepath '
                        ...
                        default='', type=str)
    parser.add_argument('--img_list_file', default='',help='for the img_list_file')
...
if __name__ == "__main__":
    ...
    if args.default is True:
        ...
        del args['default']
        args['filepath']='data/'
        args['annotation_folder'] = 'Annotations/'
        args['image_folder'] = 'JPEGImages/'
        args['img_list_file'] = 'ImageSets/trainval.txt'
        generate_symbols_and_xml(**args)
    else:
